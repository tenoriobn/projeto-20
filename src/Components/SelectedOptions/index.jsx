        ...
        <>
            <div className={styles.finishingup}>
                <article className={styles.finishingup__container}>
                    ...
                    <h5 className={styles.plan__value}>$9/mo</h5>
                </article>

                <span className={styles.line}></span>

                <article className={styles.finishingup__container}>
                    <h4 className={styles.plan__info}>Online service</h4>
                    <h5 className={styles.addons__value}>+$1/mo</h5>
                </article>

                <article className={styles.finishingup__container}>
                    <h4 className={styles.plan__info}>Larger storage</h4>
                    <h5 className={styles.addons__value}>+$2/mo</h5>
                </article>
            </div>

            <article className={styles.total__container}>
                <h4 className={styles.plan__info}>Total (per month)</h4>
